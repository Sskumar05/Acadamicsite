    ...
    >
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <h1 className="text-3xl font-bold text-[#0F172A] sm:text-4xl md:text-5xl lg:text-6xl">Activities</h1>
        ...
        {/* Intro */}
        <div className="mb-12 sm:mb-16 md:mb-20 grid md:grid-cols-2 gap-8 md:gap-12 items-center">
          <div>
          ...
          <div className="grid grid-cols-2 gap-3 sm:gap-4">
            <img src="https://images.unsplash.com/photo-1577896851231-70ef18881754?auto=format&fit=crop&w=400&q=80" alt="Students playing" className="rounded-2xl h-36 sm:h-48 w-full object-cover" />
            <img src="https://images.unsplash.com/photo-1603354350317-6f7aaaa2d145?auto=format&fit=crop&w=400&q=80" alt="Student learning" className="rounded-2xl h-36 sm:h-48 w-full object-cover mt-6 sm:mt-8" />
          </div>
        </div>

        {/* Facilities Grid */}
        <div className="mb-12 sm:mb-16 md:mb-20">
          <h2 className="text-2xl sm:text-3xl font-bold text-[#0F172A] mb-8 sm:mb-12 text-center">Our Activities</h2>
          <div className="columns-1 gap-4 sm:gap-6 sm:columns-2 lg:columns-3">
            {activitiesList.map((it) => (
              <div
                key={it.label}
                className={`group relative mb-4 sm:mb-6 break-inside-avoid overflow-hidden rounded-2xl ${it.mobileH} ${it.desktopH}`}
              >
                <img
                  src={it.img}
                  alt={it.label}
